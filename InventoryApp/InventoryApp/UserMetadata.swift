...
class UserMetadata {
    ...
    func createOneSection1() -> Section {
        ...
        let section = Section(id: UUID(), name: "保鲜区", rule: 30, products: products)
        return section
    }
    ...
    func createOneSection2() -> Section {
        let products = [
            ...
            Product(id: UUID(), title: "USDA Choice  有机西冷牛排", picture: "USDA Choice  有机西冷牛排", quantity: 6, remainingDays: 6),
            Product(id: UUID(), title: "墨西哥面卷", picture: "墨西哥面卷", quantity: 7, remainingDays: 5),
            Product(id: UUID(), title: "Healthy Choice速冻菠菜番茄拌面", picture: "Healthy Choice速冻菠菜番茄拌面", quantity: 8, remainingDays: 10),
            Product(id: UUID(), title: "墨西哥面卷", picture: "墨西哥面卷", quantity: 9, remainingDays: 4),
            Product(id: UUID(), title: "鸡蛋", picture: "鸡蛋", quantity: 10, remainingDays: 3),
            Product(id: UUID(), title: "USDA Choice  有机西冷牛排", picture: "USDA Choice  有机西冷牛排", quantity: 13, remainingDays: 10),
        ...
        let section = Section(id: UUID(), name: "冷冻区", rule: 180, products: products)
        return section
    }
    ...
    func createOneSection3() -> Section {
        ...
        let section = Section(id: UUID(), name: "常温区", rule: 35, products: products)
        return section
    }
}
